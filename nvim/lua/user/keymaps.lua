...
-- Split navigation
-- keymap("n", "<Silent><Leader>k", "wincmd k", opts)
-- keymap("n", "<Silent><Leader>j", "wincmd j", opts)
-- keymap("n", "<Silent><Leader>h", "wincmd h", opts)
-- keymap("n", "<Silent><Leader>l", "wincmd l", opts)
